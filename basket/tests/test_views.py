...
class TestBasketView(TestCase):
    def setUp(self):
        ...
        Product.objects.create(category_id=1, title='django intermediate', created_by_id=1, slug='django-beginners', price='20.00', image='django')
        Product.objects.create(category_id=1, title='django advanced', created_by_id=1, slug='django-beginners', price='20.00', image='django')
        self.client.post(
    ...
    def test_basket_add(self):
        """
        Test adding itmes to the basket
        """
